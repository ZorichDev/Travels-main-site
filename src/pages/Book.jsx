    ...
    <>
      <div className="pt-32 pb-20 px-4 bg-gradient-to-br from-navy-800 via-navy-700 to-red-800">
        <div className="max-w-4xl mx-auto text-center">
          <div className="text-[#db0303] text-xs font-bold tracking-wider mb-3">Book Travel</div>
          <h1 className="font-serif text-5xl md:text-7xl font-bold text-white">Book Your Next<br /><span className="text-[#db0303] italic">Adventure</span></h1>
      ...
      <div className="py-16 px-4 md:px-12 bg-white dark:bg-navy-950">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3 mb-12">
            {tabs.map(tab => (
              <button
                ...
                className={`p-4 rounded-xl text-center transition border ${activeTab === tab.id ? 'bg-red-50 dark:bg-red-900/20 border-red-500' : 'bg-white dark:bg-navy-900 border-gray-200 dark:border-white/10 hover:border-red-500'}`}
              >
                <div className={`${activeTab === tab.id ? 'text-red-600' : 'text-gray-600 dark:text-gray-400'} mb-2 flex justify-center`}>{tab.icon}</div>
          ...
          <div className="bg-gray-50 dark:bg-navy-900/50 rounded-2xl p-8 md:p-12 text-center border border-gray-200 dark:border-white/10">
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-3">Search & Book on Our <span className="text-red-600 italic">Full Platform</span></h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-6">
              All booking services — flights, hotels, packages, car rentals, tours and more — are available on our dedicated booking platform at <a href="https://rprotravels.com" target="_blank" className="text-red-600 font-bold hover:underline">rprotravels.com</a>. Enjoy flexible Pay Small Small payment from ₦45,000 deposit.
            </p>
            <div className="flex flex-wrap gap-4 justify-center mb-6">
              <a href="https://rprotravels.com" target="_blank" className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded font-bold uppercase tracking-wide transition">🔍 Search Flights</a>
              ...
              <a href="https://rprotravels.com" target="_blank" className="border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white px-6 py-3 rounded font-bold uppercase tracking-wide transition">🌍 View Packages</a>
            </div>
