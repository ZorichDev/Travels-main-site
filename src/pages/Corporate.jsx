    ...
    <>
      <div className="pt-32 pb-20 px-4 bg-gradient-to-br from-navy-800 via-navy-700 to-red-800">
        <div className="max-w-4xl mx-auto text-center">
          <div className="text-[#db0303] text-xs font-bold tracking-wider mb-3">Corporate & Institutional</div>
          <h1 className="font-serif text-5xl md:text-7xl font-bold text-white">Enterprise Travel<br /><span className="text-[#db0303] italic">Simplified</span></h1>
      ...
      <div className="py-16 px-4 md:px-12 bg-white dark:bg-navy-950">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="text-red-600 text-xs font-bold tracking-wider mb-3">Solutions</div>
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">What We Do For <span className="text-red-600 italic">Businesses</span></h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mt-3">From SMEs to multinationals — tailored travel solutions that save time, reduce costs and eliminate headaches.</p>
          </div>
          ...
          <div className="mb-20">
            <div className="text-red-600 text-xs font-bold tracking-wider mb-3">Plans</div>
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">Corporate <span className="text-red-600 italic">Plan Comparison</span></h2>
              ...
              <table className="w-full bg-gray-50 dark:bg-navy-900 rounded-xl overflow-hidden border border-gray-200 dark:border-white/10">
                <thead>
                  <tr className="bg-gray-100 dark:bg-navy-800">
                    <th className="px-5 py-3 text-left text-xs font-bold text-red-600 uppercase tracking-wider">Feature</th>
          ...
          <div className="bg-gradient-to-r from-navy-800 to-navy-900 rounded-2xl p-8 md:p-12 flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              <h3 className="font-serif text-3xl md:text-4xl font-bold text-white">Ready to Simplify<br /><span className="text-[#db0303] italic">Corporate Travel?</span></h3>
            ...
            <div className="flex flex-col gap-3">
              <Link to="/contact">
                <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded font-bold uppercase tracking-wide transition">Book a Consultation</button>
              </Link>
              <button className="border border-white/40 text-white/90 hover:text-red-600 hover:border-red-600 px-6 py-3 rounded font-bold uppercase tracking-wide transition">Download Brochure</button>
            </div>
          </div>
        </div>
      </div>
